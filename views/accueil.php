    ...
    <div class="lightbulb-div">
      ...
      <img data-aos="fade-up" data-aos-duration="300" data-aos-delay="100" src="../assets/images/logo.svg" alt="Image ampoule énergie verte" class="lightbulb-img" id="lightbulb-img">
        ...
        <div class="discover-card" data-aos="fade-up" data-aos-duration="750">
          ...
          <h1>Découvrez <span style="color: #007d3e;">Jonben</span></h1>
          <h2>Entreprise de conseil </h2>
          <p>
            Fier de 20 ans d'expérience, Jonben intervient dans les grands projets de construction de centrale de production énegétique ou de maintien en condition d'exploitation, dans le respect de la réglementation et des normes en vigueur. <br> 
          </p>
          <div class="custom-button" id="custom-button" data-aos="flip-up" data-aos-delay="150">
            <div id="circle"></div>
            <a href="presentation.php">Nous découvrir</a>
          </div>
